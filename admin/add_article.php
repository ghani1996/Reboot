...
if(isset($_POST['add']))
{
	...
	$date = date("Y/m/d");
	$query= "INSERT INTO blog (title,story,email,date,category,sub,status) VALUES ('$title', '$story', '$login_session', '$date', '$cat', '$sub', 'Approved')";
	$msg="Your article has been added";
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active"><a href="#"><i class="fa fa-paste"></i><span>ARTICLES</span><i class="fa fa-angle-right"></i></a>
