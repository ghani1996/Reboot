...
if(isset($_POST['add']))
{
	...
	$date = date("Y/m/d");
	$query= "UPDATE users SET sub = '$sub' WHERE name='{$_SESSION['name']}'";
	$msg="Your favourite has been updated";
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class="fa fa-paste"></i><span>ARTICLES</span><i class="fa fa-angle-right"></i></a>
            ...
            <li class="active"><a href="follow.php"><i class="fa fa-heart"></i><span>FOLLOW</span></a></li>    
          </ul>
        </section>
      </aside>
      <!--body part-->
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-paste"></i> Follow</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-md-10">
            <div class="card">
             <?php
				...
				$sub = $row['sub'];
			 ?>
              <h3 class="card-title">My Followed Category : <?php echo $sub; ?> </h3>
              <?php
              if ($msg != "")
				  {
