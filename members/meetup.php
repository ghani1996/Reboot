...
if(isset($_POST['add']))
{
	...
	$part = $_POST['part'];
	$query= "INSERT INTO meetup (program, venue, dates, starttime, endtime, participant, organiser) VALUES ('$program', '$venue', '$dates', '$starttime', '$endtime', '$part', '{$_SESSION['name']}')";
  ...
  <body class="sidebar-mini fixed">
    ...
    <script src="../layout/js/main2.js"></script>  
      ...
      function validateForm()
      {
		...
		{
            alert("Please insert the starting date");
			window.setTimeout(function ()
			{
